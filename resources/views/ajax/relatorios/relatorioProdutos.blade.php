        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <li class="nav-item has-treeview menu-open">
              ...
              <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="{{url('/relatorio/indexproducts')}}" class="nav-link active">
                      <i class="fas fa-file-alt"></i>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Relatorio de Produtos</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
       ...
       <section class="content">
        ...
        <main>
          <div class="main-content">   
            ...
            ?>
            <form action="{{route('report.products',$name)}}" >
              <div class="form-row">
                {{-- <div class="form-group col-md-6">
                  <label for="inputemail">Preço</label>
                  <input type="text" name="filtroPreco" class="form-control" placeholder="Filtrar por Preço:" id="inputEmail"  value="{{old('filtroEmail')}}">
                </div> --}}
                <div class="form-group col-md-6">
