          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active"><a href="{{route('index.category')}}">Visualizar Categorias</a></li>
                <li class="breadcrumb-item ">Cadastrar Categorias</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
          ...
          <div class="row">
            ...
            <section class="col-lg-12 connectedSortable">
              ...
              <div class="card direct-chat direct-chat-primary">
                ...
                <div class="card-body">
                  <main>
                    <form action="{{route('store.category')}}" method="post" enctype="multipart/form-data" name="form-categoria" onsubmit="return validarCategoria()">
                            ...
                            <div class="panel-cad-cadastro">
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input class="form-control"  type="text" name="category" placeholder="Categoria:"  value="{{$product->description??old('category_category')}}">
                                        <div style="color: red ; background:rgb(233, 163, 163)"><small id="erro1"></small></div><br>
                                    </div>
                                </div>
                                <div class="butons">
                                    <button type="submit" class="btn btn-success"> Salvar </button>
                                    <a href="{{route('index.category')}}" class="btn btn-default"> Cancelar</a>
                                </div>  
                            </div>
