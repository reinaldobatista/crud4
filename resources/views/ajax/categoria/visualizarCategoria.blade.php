@extends('layout.apps')
@section('title')
<title>MyCrud/VisualizarCategoria</title>
@endsection
@section('content')
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Visualizar Categorias</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                                        ...
                                        <tbody >
                                          ...
                                          <tr role="row" class="odd">
                                            ...
                                            <td>
                                                  ...
                                                  <form class="form-danger" id="{{$category->id}}" action="{{route('destroy.category',$category->id)}}"  method="POST">   
                                                    @method('DELETE')
                                                    @csrf
                                                    <button type="submit" class="btn btn-danger" data-toggle="" >
