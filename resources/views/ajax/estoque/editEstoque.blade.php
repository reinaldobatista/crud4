          ...
          <div class="row">
            ...
            <section class="col-lg-12 connectedSortable">
              ...
              <div class="card direct-chat direct-chat-primary">
                ...
                <div class="card-body">
                  <main>
                    <form action="{{route('update.story',$story->id)}}" method="post" name="form-estoque" enctype="multipart/form-data" onsubmit="return validarEstoque()">
                        @method('PUT')
                            ...
                            <div class="panel-cad-cadastro">
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input class="form-control" type="text" name="story" value="{{$story->story??old('story')}}">
                                        <div style="color: red; background:rgb(233, 163, 163)"><small id="erro1"></small></div><br>
                                    </div>
                                    <input class="form-control" hidden type="text" name="id" value="{{$story->id}}">
                                </div>
                                <div class="butons">
