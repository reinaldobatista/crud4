  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Visualizar Estoques</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{route('index.home')}}">Menu</a></li>
              <li class="breadcrumb-item active">Visualizar Estoques</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                                          ...
                                          <tr role="row" class="odd">
                                            ...
                                            <td>
                                                  <a href="{{route('edit.story',$story->id)}}">
                                                    <button class="btn btn-primary" a-view="editStory" a-folder="story/{{$story->id}}" onclick="fetchContent(this)">
