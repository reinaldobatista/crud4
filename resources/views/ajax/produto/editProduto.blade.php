          ...
          <div class="row">
            ...
            <section class="col-lg-12 connectedSortable">
              ...
              <div class="card direct-chat direct-chat-primary">
                ...
                <div class="card-body">
                  <main>
                    <form action="{{route('update.products',$product->id)}}" name="form-product" method="post" enctype="multipart/form-data" onsubmit="return validarEditpro()">
                        @method('PUT')
                            ...
                            <div class="panel-cad-cadastro">
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input class="form-control"  type="text" name="price" placeholder="Preço:"  value="{{$preco ?? old('price')}}">
                                        <div style="color: red; background:rgb(233, 163, 163) "><small id="erro2"></small></div><br>
                                    </div>
                                    <div class="form-group col-md-12">
                                        <label for=""> Descrição:</label>
                                        <textarea class="form-control" rows="6"  type="text" name="description" placeholder="Descrição:"  value="">{{$product->description}}</textarea>
                                    ...
                                    <div class="form-group col-md-6">
                                      <label for=""> <br> </label>
                                        <input value="{{$product->image?? old('image')}}" class="form-control" type="file" name="image" class="form-control"><br>
